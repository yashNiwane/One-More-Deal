...
class AddBuilderPropertyScreen extends StatefulWidget {
  ...
  @override
  State<AddBuilderPropertyScreen> createState() =>
      _AddBuilderPropertyScreenState();
}
              ...
              Padding(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(color: AppColors.iosSystemBlue.withOpacity(0.3)),
                  ),
                  child: Row(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'Note: Only one property can be active at a time. If you add a new property, your older active property will be set to inactive.',
                          style: GoogleFonts.inter(
                            fontSize: 12,
                            color: AppColors.iosSystemBlue,
                            fontWeight: FontWeight.w500,
                      ...
                      children: [
                        ...
                        Text(
                          _possessionDate != null
                              ? DateFormat('MM/yyyy').format(_possessionDate!)
                              : 'Select',
                          style: GoogleFonts.inter(
                            fontSize: 15,
                ...
                Padding(
                  ...
                  child: OutlinedButton.icon(
                    ...
                    style: OutlinedButton.styleFrom(
                      ...
                      side: BorderSide(
                        color: AppColors.iosSystemBlue.withOpacity(0.4),
                      ),
                ...
                if (_variants.length > 1)
                  GestureDetector(
                    ...
                    child: Icon(
                      ...
                      color: AppColors.iosDestructive.withOpacity(0.7),
                      size: 22,
                    ),
                  ),
              ],
